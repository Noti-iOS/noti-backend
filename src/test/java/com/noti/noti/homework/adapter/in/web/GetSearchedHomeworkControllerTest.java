  ...
  class getSearchedHomeworkInfo_메소드는 {
    ...
    class 조건이_유효하면_응답코드_200 {
      ...
      void 조건에_해당하는_숙제목록이_존재하면_해당_리스트_반환() throws Exception {
        ...
        byte[] content = objectMapper.writeValueAsBytes(new SearchedHomeworkRequest("", 3, "111111111111111111111111"));
      ...
      void 조건에_해당하는_숙제목록이_없다면_searchedHomeworks가_빈_리스트_반환() throws Exception {
        ...
        byte[] content = objectMapper.writeValueAsBytes(new SearchedHomeworkRequest("", 0, "111111111111111111111111"));
